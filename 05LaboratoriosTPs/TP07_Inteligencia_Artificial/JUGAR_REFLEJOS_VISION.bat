@echo off
REM Inicia el juego de reflejos con VISION ARTIFICIAL para el robot Unitree G1.
REM El robot detecta las luces usando su camara y procesamiento de imagenes (NumPy).
cd /d "%~dp0"

echo ============================================================
echo    JUEGO DE REFLEJOS CON VISION ARTIFICIAL — UNITREE G1
echo ============================================================
echo.
...
echo      1)  Aleatorio (Mayor desafio de reflejos con vision)
...
echo.
echo    Iniciando simulacion y detector optico de vision...
echo.
call EJECUTAR_MI_CODIGO.bat mi_desarrollo\juego_reflejos_vision.py %ARGS_EXTRA%
